...
interface DCalendarsSubstrateProps {
    substrate: typeof TCmodel
}

const DCalendarsSubstrate = (props:DCalendarsSubstrateProps) => {
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={4}>
                    <Paper className={`paper`}>
                        <Typography variant={`h6`}>
                            {material.density} &nbsp;
                            <small className="text-muted" style={{fontSize: "16px"}}>гр</small>
                        </Typography>
                        <span>Плотность</span>
                    </Paper>
                </Grid>
...
export default DCalendarsSubstrate;