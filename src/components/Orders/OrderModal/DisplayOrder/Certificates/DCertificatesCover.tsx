...
interface DCertificatesCoverProps {
    cover: typeof TCmodel,
    hard: typeof TCmodel
}

const DCertificatesCover = (props:DCertificatesCoverProps) => {
...
export default DCertificatesCover;