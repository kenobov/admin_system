...
import {BsBookmarksFill, BsPrinterFill} from "react-icons/bs";

interface DFoldersInsertProps {
    insert: typeof TCmodel,
    hard: typeof TCmodel
}

const DFoldersInsert = (props:DFoldersInsertProps) => {
