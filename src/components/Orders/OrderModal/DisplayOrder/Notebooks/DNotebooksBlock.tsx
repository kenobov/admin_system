...
import {GiPapers, GiStaplerHeavyDuty, GiRibbon, GiWireCoil} from "react-icons/gi";
import {BsPrinterFill, BsBookmarksFill} from "react-icons/bs";
import {MdOutlineGrid4X4} from "react-icons/md";

interface DNotebooksBlockProps {
    block: typeof TCmodel,
    hard: typeof TCmodel
}

const DNotebooksBlock = (props:DNotebooksBlockProps) => {
...
export default DNotebooksBlock;