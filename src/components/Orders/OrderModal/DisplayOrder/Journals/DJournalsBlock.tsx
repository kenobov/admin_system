...
import {GiPapers, GiStaplerHeavyDuty} from "react-icons/gi";
import {BsPrinterFill} from "react-icons/bs";

interface DJournalsBlockProps {
    block: typeof TCmodel,
    hard:  typeof TCmodel
}

const DJournalsBlock = (props:DJournalsBlockProps) => {
